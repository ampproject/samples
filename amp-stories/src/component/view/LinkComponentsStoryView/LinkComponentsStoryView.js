...
class LinkComponentsStoryView extends React.Component {
  render() {
    return (
      <React.Fragment>
        <Head />
        <AmpStory
          standalone=""
          title="Links, CTAs, and Ads"
          publisher="AMP tutorials"
          publisher-logo-src="/static/stories/publisher_logo.png"
          poster-square-src="/static/stories/story5/thumbnail.png"
        ...
        >
          ...
          <StoryPage8 />
          <amp-story-bookend
            src="/static/stories/story5/bookend.json"
            layout="nodisplay"
          />
        </AmpStory>
      </React.Fragment>
...
export default LinkComponentsStoryView;
