...
class LayoutStoryView extends React.Component {
  render() {
    return (
      <React.Fragment>
        <Head />
        <AmpStory
          standalone=""
          title="Set up your story with layout"
          publisher="AMP tutorials"
          publisher-logo-src="/static/stories/publisher_logo.png"
          poster-square-src="/static/stories/story4/thumbnail.png"
        ...
        >
          ...
          <amp-story-bookend
            layout="nodisplay"
            src="/static/stories/story4/bookend.json"
          />
        </AmpStory>
      </React.Fragment>
    );
...
export default LayoutStoryView;
